...
--               /home/jizz/Documents/kv260-DPU-TDR/servo_bearmetal_test/servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ip/servo_test_bd_servo_generator_0_0/servo_test_bd_servo_generator_0_0_sim_netlist.vhdl
-- Design      : servo_test_bd_servo_generator_0_0
...
entity servo_test_bd_servo_generator_0_0_servo_generator_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME of servo_test_bd_servo_generator_0_0_servo_generator_v1_0_S00_AXI : entity is "servo_generator_v1_0_S00_AXI";
end servo_test_bd_servo_generator_0_0_servo_generator_v1_0_S00_AXI;

architecture STRUCTURE of servo_test_bd_servo_generator_0_0_servo_generator_v1_0_S00_AXI is
  ...
  signal current_period_sig : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_servo_state[1]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FSM_sequential_servo_state[1]_i_5\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \count_sig[10]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \count_sig[11]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \count_sig[12]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \count_sig[13]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \count_sig[14]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \count_sig[15]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \count_sig[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \count_sig[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \count_sig[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \count_sig[5]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \count_sig[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \count_sig[7]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \count_sig[8]_i_1\ : label is "soft_lutpair3";
...
\count_sig[14]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5104"
    )
        port map (
...
\current_period_sig_reg[11]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => current_period_sig_0,
      D => slv_reg0(11),
...
\current_period_sig_reg[12]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => current_period_sig_0,
      D => slv_reg0(12),
...
\current_period_sig_reg[13]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => current_period_sig_0,
      D => slv_reg0(13),
...
\current_period_sig_reg[14]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => current_period_sig_0,
      D => slv_reg0(14),
...
\current_period_sig_reg[15]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => current_period_sig_0,
      D => slv_reg0(15),
...
servo_o_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6FF6FFFFFFFF6FF6"
    )
        port map (
...
servo_o_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity servo_test_bd_servo_generator_0_0_servo_generator_v1_0 is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of servo_test_bd_servo_generator_0_0_servo_generator_v1_0 : entity is "servo_generator_v1_0";
end servo_test_bd_servo_generator_0_0_servo_generator_v1_0;

architecture STRUCTURE of servo_test_bd_servo_generator_0_0_servo_generator_v1_0 is
begin
servo_generator_v1_0_S00_AXI_inst: entity work.servo_test_bd_servo_generator_0_0_servo_generator_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity servo_test_bd_servo_generator_0_0 is
  port (
    servo_o : out STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of servo_test_bd_servo_generator_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of servo_test_bd_servo_generator_0_0 : entity is "servo_test_bd_servo_generator_0_0,servo_generator_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of servo_test_bd_servo_generator_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of servo_test_bd_servo_generator_0_0 : entity is "servo_generator_v1_0,Vivado 2022.1";
end servo_test_bd_servo_generator_0_0;

architecture STRUCTURE of servo_test_bd_servo_generator_0_0 is
  signal \<const0>\ : STD_LOGIC;
  attribute x_interface_info : string;
  attribute x_interface_info of s00_axi_aclk : signal is "xilinx.com:signal:clock:1.0 S00_AXI_CLK CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of s00_axi_aclk : signal is "XIL_INTERFACENAME S00_AXI_CLK, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN servo_test_bd_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0";
...
U0: entity work.servo_test_bd_servo_generator_0_0_servo_generator_v1_0
     port map (
