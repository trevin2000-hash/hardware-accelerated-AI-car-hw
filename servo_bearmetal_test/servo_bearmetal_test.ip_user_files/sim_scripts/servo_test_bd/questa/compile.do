...
vlog -work xpm -64 -incr -mfcu -sv -L axi_vip_v1_1_12 -L zynq_ultra_ps_e_vip_v1_0_12 -L xilinx_vip "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
...
vlog -work axi_infrastructure_v1_1_0 -64 -incr -mfcu "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
"../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_vip_v1_1_12 -64 -incr -mfcu -sv -L axi_vip_v1_1_12 -L zynq_ultra_ps_e_vip_v1_0_12 -L xilinx_vip "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
"../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/1033/hdl/axi_vip_v1_1_vl_rfs.sv" \

vlog -work zynq_ultra_ps_e_vip_v1_0_12 -64 -incr -mfcu -sv -L axi_vip_v1_1_12 -L zynq_ultra_ps_e_vip_v1_0_12 -L xilinx_vip "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
"../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl/zynq_ultra_ps_e_vip_v1_0_vl_rfs.sv" \

vlog -work xil_defaultlib -64 -incr -mfcu "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
...
vlog -work generic_baseblocks_v2_1_0 -64 -incr -mfcu "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
"../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \

vlog -work axi_register_slice_v2_1_26 -64 -incr -mfcu "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
"../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/0a3f/hdl/axi_register_slice_v2_1_vl_rfs.v" \

vlog -work fifo_generator_v13_2_7 -64 -incr -mfcu "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
...
vlog -work axi_data_fifo_v2_1_25 -64 -incr -mfcu "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
"../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/5390/hdl/axi_data_fifo_v2_1_vl_rfs.v" \

vlog -work axi_crossbar_v2_1_27 -64 -incr -mfcu "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
...
vlog -work axi_protocol_converter_v2_1_26 -64 -incr -mfcu "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
"../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/90c8/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \

vlog -work axi_clock_converter_v2_1_25 -64 -incr -mfcu "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
"../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/e893/hdl/axi_clock_converter_v2_1_vl_rfs.v" \

vlog -work blk_mem_gen_v8_4_5 -64 -incr -mfcu "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
"../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/25a8/simulation/blk_mem_gen_v8_4.v" \

vlog -work axi_dwidth_converter_v2_1_26 -64 -incr -mfcu "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/ec67/hdl" "+incdir+../../../../servo_bearmetal_test.gen/sources_1/bd/servo_test_bd/ipshared/8cdf/hdl" "+incdir+/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
